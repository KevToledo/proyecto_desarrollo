			...
			<div class="col-8">
			 ...
			 <div class="box">
				<div class="box-header with-border">
				  <h3 class="box-title">Listado de SubCategorias <span class="badge badge-pill badge-danger"> {{ count($subcategory) }} </span> </h3>
				</div>
				<!-- /.box-header -->
				<div class="box-body">
					<div class="table-responsive">
					  <table id="example1" class="table table-bordered table-striped">
						<thead>
							<tr>
								<th>Categoria </th>
								<th>SubCategoria Español</th>
								<th>SubCategoria Ingles </th>
								<th>Accion</th>
...
<!--   ------------ Agregar SubCategoria -------- -->
 ...
 <form method="post" action="{{ route('subcategory.store') }}" >
	...
	<div class="form-group">
		<h5>SubCategoria Español <span class="text-danger">*</span></h5>
		<div class="controls">
	...
	<div class="form-group">
		<h5>SubCategoria Ingles <span class="text-danger">*</span></h5>
		<div class="controls">
