			...
			<div class="col-8">
			 ...
			 <div class="box">
				<div class="box-header with-border">
				  <h3 class="box-title">Listado de categorias <span class="badge badge-pill badge-danger"> {{ count($category) }} </span></h3>
				</div>
				<!-- /.box-header -->
				<div class="box-body">
					<div class="table-responsive">
					  <table id="example1" class="table table-bordered table-striped">
						<thead>
							<tr>
								<th>Icono Categoria </th>
								<th>Categoria Español</th>
								<th>Categoria Ingles </th>
								<th>Accion</th>
...
<!--   ------------ Agregar Categoria -------- -->
 ...
 <form method="post" action="{{ route('category.store') }}" >
	 ...
	 <div class="form-group">
		<h5>Categoria Español <span class="text-danger">*</span></h5>
		<div class="controls">
	...
	<div class="form-group">
		<h5>Categoria Ingles <span class="text-danger">*</span></h5>
		<div class="controls">
