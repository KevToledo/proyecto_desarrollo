  ...
  <form method="post" action="{{ route('product-update') }}" >
	...
	<div class="controls">
		<select name="brand_id" class="form-control" required="" >
			<option value="" selected="" disabled="">Seleccine Marca</option>
 ...
 <option value="{{ $subsub->id }}" {{ $subsub->id == $products->subsubcategory_id ? 'selected': '' }} >{{ $subsub->subsubcategory_name_en }}</option>	
	 ...
	 @enderror
			...
			<div class="col-md-4">
				 ...
				 <div class="form-group">
			<h5>Nombre Producto en Ingles <span class="text-danger">*</span></h5>
			<div class="controls">
  ...
  <input type="text" name="product_code" class="form-control" required="" value="{{ $products->product_code }}">
	 ...
	 @enderror
			...
			<div class="col-md-4">
				 ...
				 <div class="form-group">
			<h5>Tag Producto Español <span class="text-danger">*</span></h5>
			<div class="controls">
...
<div class="row"> <!-- start 4th row  -->
	    ...
	    <div class="form-group">
			<h5>Tag Producto Ingles <span class="text-danger">*</span></h5>
			<div class="controls">
...
<div class="row"> <!-- start 5th row  -->
	    ...
	    <div class="form-group">
			<h5>Color Producto Español <span class="text-danger">*</span></h5>
			<div class="controls">
	 ...
	 @enderror
			...
			<div class="col-md-6">
				 ...
				 <div class="form-group">
			<h5>Color Producto Ingles <span class="text-danger">*</span></h5>
			<div class="controls">
...
<div class="row"> <!-- start 7th row  -->
	    ...
	    <div class="form-group">
			<h5>Descricion corta en Español <span class="text-danger">*</span></h5>
			<div class="controls">
...
<div class="row"> <!-- start 8th row  -->
	    ...
	    <div class="form-group">
			<h5>Descricion completa Español <span class="text-danger">*</span></h5>
			<div class="controls">
	<textarea id="editor1" name="long_descp_en" rows="10" cols="80" required="">
		{!! $products->long_descp_en !!}
	     ...
	     <div class="form-group">
			<h5>Descripcion completa Ingles <span class="text-danger">*</span></h5>
			<div class="controls">
		...
		<div class="controls">
		 ...
		 <input type="checkbox" id="checkbox_2" name="hot_deals" value="1" {{ $products->hot_deals == 1 ? 'checked': '' }}>
			...
			<fieldset>
				...
				<label for="checkbox_3">Destacados</label>
			</fieldset>
		</div>
	</div>
</div>
...
<div class="col-md-12">
		 ...
		 <h4 class="box-title">Imagenes multiples del producto <strong>Actualizar</strong></h4>
				  </div>
...
<div class="col-md-12">
				<div class="box bt-3 border-info">
				  <div class="box-header">
		 <h4 class="box-title">Miniatura del producto <strong>Actualizar</strong></h4>
				  </div>
