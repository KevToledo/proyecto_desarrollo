...
<div class="container-full">
	 ...
	 <div class="form-group">
		<h5>Nombre Usuario Admin  <span class="text-danger">*</span></h5>
		<div class="controls">
	...
	<div class="row">
	 ...
	 <div class="form-group">
		<h5>Admin User Telefono  <span class="text-danger">*</span></h5>
		<div class="controls">
	 <input type="text" name="phone" class="form-control" > </div>
	  ...
	  <div class="form-group">
		<h5>Admin Contraseña  <span class="text-danger">*</span></h5>
		<div class="controls">
	 ...
	 <div class="row">
				...
				<div class="col-md-6">
		<div class="form-group">
		<h5>Imagen Usuario Admin <span class="text-danger">*</span></h5>
		<div class="controls">
...
<div class="col-md-4">
		...
		<div class="controls">
			<fieldset>
				...
				<label for="checkbox_7">Envios</label>
			</fieldset>
			<fieldset>
			...
			<fieldset>
				...
				<label for="checkbox_9">Configuraciones</label>
			</fieldset>


			<fieldset>
				<input type="checkbox" id="checkbox_10" name="returnorder" value="1">
				<label for="checkbox_10">Devolucion de Ordenes</label>
			</fieldset>

			<fieldset>
				<input type="checkbox" id="checkbox_11" name="review" value="1">
				<label for="checkbox_11">Reseñas</label>
			</fieldset>
		</div>
	</div>
</div>
	...
	<div class="form-group">
		...
		<div class="controls">
			<fieldset>
				...
				<label for="checkbox_12">Ordenes</label>
			</fieldset>
			<fieldset>
			...
			<fieldset>
				...
				<label for="checkbox_14">Reportes</label>
			</fieldset>

			<fieldset>
				<input type="checkbox" id="checkbox_15" name="alluser" value="1">
				<label for="checkbox_15">Todos los Usuarios</label>
			</fieldset>

			<fieldset>
				<input type="checkbox" id="checkbox_16" name="adminuserrole" value="1">
				<label for="checkbox_16">Roles Usuarios Admin</label>
			</fieldset>
		</div>
			</div>
		</div>
