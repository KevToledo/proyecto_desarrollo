...
<!--   ------------ Editar MARCA ya registrada-------- -->
 ...
 <form method="post" action="{{ route('brand.update',$brand->id) }}" enctype="multipart/form-data">
	 ...
	 <div class="form-group">
		<h5>Nombre de marca Español  <span class="text-danger">*</span></h5>
		<div class="controls">
	...
	<div class="form-group">
		<h5>Nombre de marca Ingles <span class="text-danger">*</span></h5>
		<div class="controls">
	...
	<div class="form-group">
		<h5>Imagen Marca <span class="text-danger">*</span></h5>
		<div class="controls">
