...
<div class="container-full">
		 ...
		 <!-- Basic Forms -->
		  <div class="box">
			<div class="box-header with-border">
			  <h4 class="box-title">Configuracion Pagina Search Engine Optimization -SEO-  </h4>
	...
	<div class="form-group">
		<h5>Titulo Meta <span class="text-danger">*</span></h5>
		<div class="controls">
 ...
 <div class="form-group">
			<h5>Descricion Analitas <span class="text-danger">*</span></h5>
			<div class="controls">
