...
<div class="container-full">
		 ...
		 <!-- Basic Forms -->
		  <div class="box">
			<div class="box-header with-border">
			  <h4 class="box-title">Configuraciones del Sitio </h4>
	 ...
	 <div class="form-group">
		<h5>Logo del sitio 139X36  <span class="text-danger"> </span></h5>
		<div class="controls">
	...
	<div class="form-group">
		<h5>Telefono #1 <span class="text-danger">*</span></h5>
		<div class="controls">
	...
	<div class="form-group">
		<h5>Telefono #2 <span class="text-danger">*</span></h5>
		<div class="controls">
...
<div class="form-group">
		<h5>Nombre Empresa <span class="text-danger">*</span></h5>
		<div class="controls">
	...
	<div class="form-group">
		<h5>Direccion Empresa <span class="text-danger">*</span></h5>
		<div class="controls">
