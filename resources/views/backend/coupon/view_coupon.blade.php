...
@section('admin')
  ...
  <!-- Content Wrapper. Contains page content -->
	  ...
	  <div class="container-full">
		...
		<!-- Agregar Cupon y Listado de Cupones -->
...
<!--   ------------ Agregar Cupon -------- -->
 ...
 <form method="post" action="{{ route('coupon.store') }}" >
	 ...
	 <div class="form-group">
		<h5>Nombre Cupon  <span class="text-danger">*</span></h5>
		<div class="controls">
	...
	<div class="form-group">
		<h5>Descuento Cupon (%) <span class="text-danger">*</span></h5>
		<div class="controls">
	...
	<div class="form-group">
		<h5>Fecha de validez de Cupon  <span class="text-danger">*</span></h5>
		<div class="controls">
