...
<body class="hold-transition theme-primary bg-gradient-primary">
	...
	<div class="content-top-agile p-10">
		...
		<p class="text-white-50">Ingrese sus credenciales</p>							
	</div>
	<div class="p-30 rounded30 box-shadowed b-2 b-dashed">

 <form method="POST" action="{{ isset ? url('/login') : route('login') }}">
            @csrf 
 ...
 <input type="password" id="password" name="password" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Password">
		...
		<div class="text-center">
			<p class="mt-15 mb-0 text-white">No tienes cuenta? <a href="auth_register.html" class="text-info ml-5">Sign Up</a></p>
		</div>
						</div>
					</div>
				</div>
