...
<div class="body-content">
	...
	<div class="row">
		...
		<div class="col-md-12">
			<form class="register-form" role="form">
				<div class="form-group">
			    <label class="info-title" for="exampleInputComments">Tus comentarios <span>*</span></label>
			    <textarea class="form-control unicase-form-control" id="exampleInputComments" ></textarea>
			  </div>
			</form>
		</div>
		<div class="col-md-12 outer-bottom-small m-t-20">
			<button type="submit" class="btn-upper btn btn-primary checkout-page-button">Enviar comentarios</button>
		</div>
	</div>
</div>
				</div>
    ...
    <form>
        <div class="control-group">
            <input placeholder="Escriba algo para buscar" class="search-field">
...
<div class="sidebar-widget outer-bottom-xs wow fadeInUp">
	<h3 class="section-title">Categorias del Blog</h3>
