  ...
  <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
    <tr>
        <td valign="top">
          ...
          <h2 style="color: green; font-size: 26px;"><strong>TRANSPORT</strong></h2>
        </td>
        <td align="right">
            <pre class="font" >
               TRANSPORT
    ...
    <tr>
        <td>
          <p class="font" style="margin-left: 20px;">
           ...
           <strong>Telefono:</strong> {{ $order->phone }} <br>
        ...
        <td>
          <p class="font">
            ...
            Fecha de Orden: {{ $order->order_date }} <br>
             Fecha de la orden: {{ $order->delivered_date }} <br>
    ...
    <tbody>
     ...
     @foreach($orderItem as $item)
      <tr class="font">
        ...
        <td align="center">Q{{ $item->price }}</td>
        <td align="center">Q{{ $item->price * $item->qty }} </td>
      </tr>
      @endforeach
  ...
  <table width="100%" style=" padding:0 10px 0 10px;">
    <tr>
        <td align="right" >
            ...
            {{-- <h2><span style="color: green;">Pagado</h2> --}}
        </td>
    </tr>
  </table>
