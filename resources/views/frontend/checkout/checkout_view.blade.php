...
<div class="panel panel-default checkout-step-01">
	...
	<div id="collapseOne" class="panel-collapse collapse in">
	    ...
	    <div class="panel-body">
		 ...
		 <h4 class="checkout-subtitle"><b>Direccion de Envio</b></h4>
	...
	<form class="register-form" action="{{ route('checkout.store') }}" method="POST">
	    ...
	    <label class="info-title" for="exampleInputEmail1"><b>Nombre de envio</b>  <span>*</span></label>
...
<div class="form-group">
	    <label class="info-title" for="exampleInputEmail1"><b>Telefono</b>  <span>*</span></label>
	  ...
	  <div class="form-group">
	    <label class="info-title" for="exampleInputEmail1"><b>Codigo postal </b> <span>*</span></label>
...
<div class="form-group">
 ...
 <option value="{{ $item->id }}">{{ $item->division_name }}</option>	
    ...
    <div class="form-group">
	 <label class="info-title" for="exampleInputEmail1">Agregar direccion especifica <span>*</span></label>
	...
	<div class="panel-group">
		<div class="panel panel-default">
			<div class="panel-heading">
		    	<h4 class="unicase-checkout-title">El progreso de tu Checkout</h4>
		    </div>
		    <div class="">
				<ul class="nav nav-checkout-progress list-unstyled">
					...
					<li> 
						<strong>Qty: </strong>
						 ...
						 <strong>Tamaño o presentacion: </strong>
						 {{ $item->options->size }}
					</li>
                    @endforeach 
<hr>
...
( {{ session()->get('coupon')['coupon_discount'] }} % )
 ...
 <strong>Descuento del cupon : </strong> ${{ session()->get('coupon')['discount_amount'] }} 
 <hr>

  <strong>Gran Total : </strong> ${{ session()->get('coupon')['total_amount'] }} 
 <hr>
...
<strong>Gran Total : </strong> ${{ $cartTotal }} <hr>
...
<div class="checkout-progress-sidebar ">
	<div class="panel-group">
		<div class="panel panel-default">
			<div class="panel-heading">
		    	<h4 class="unicase-checkout-title">Seleccione un metodo de pago</h4>
		    </div>


		    <div class="row">
		    	<div class="col-md-4">
		   <label for="">Medios digitales Stripe</label> 		
...
<hr>
  <button type="submit" class="btn-upper btn btn-primary checkout-page-button">Proceder con el pago</button>
