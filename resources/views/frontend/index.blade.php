...
<link rel="icon" href="{{ asset('backend/images/c.png') }}">
<div class="body-content outer-top-xs" id="top-banner-and-menu">
 ...
 <div class="product-price"> <span class="price"> Q{{ $product->selling_price }} </span> </div>
   ...
   @include('frontend.common.product_tags')
        ...
        <div class="sidebar-widget outer-bottom-small wow fadeInUp">
          <h3 class="section-title">Tratos Especiales</h3>
          <div class="sidebar-widget-body outer-top-xs">
            <div class="owl-carousel sidebar-carousel special-offer custom-carousel owl-theme outer-top-xs">
          ...
          <div class="sidebar-widget-body outer-top-xs">
            ...
            <form>
              <div class="form-group">
                <label class="sr-only" for="exampleInputEmail1">Correo</label>
                <input type="email" class="form-control" id="exampleInputEmail1" placeholder="aun no esta operativo">
              </div>
            ...
            <div class="row">
              <div class="col-md-6 col-sm-4 col-lg-4">
                <div class="info-box">
                  <div class="row">
                    <div class="col-xs-12">
                      <h4 class="info-box-heading green">CALIDA DE SERVICIO</h4>
                    </div>
                  </div>
                  <h6 class="text">GARANTIA DE 30 DIAS</h6>
                </div>
              </div>
              <!-- .col -->
              ...
              <div class="hidden-md col-sm-4 col-lg-4">
                <div class="info-box">
                  <div class="row">
                    <div class="col-xs-12">
                      <h4 class="info-box-heading green">CALIDAD DE PRODUCTOS Y SERVICIOS</h4>
                    </div>
                  </div>
                  <h6 class="text">Con soporte de proveedores internacionales</h6>
                </div>
              </div>
              <!-- .col -->
              ...
              <div class="col-md-6 col-sm-4 col-lg-4">
                <div class="info-box">
                  <div class="row">
                    <div class="col-xs-12">
                      <h4 class="info-box-heading green">CALIDAD HUMANA</h4>
                    </div>
                  </div>
                  <h6 class="text">100% De compromiso </h6>
                </div>
              </div>
              <!-- .col --> 
            </div>
       ...
       <div class="image"> <a href="{{ url('product/details/'.$product->id.'/'.$product->product_slug_en ) }}"><img  src="{{ asset($product->product_thambnail) }}" alt=""></a> </div>
        ...
        @endphp                  
          ...
          <div>
            ...
            <div class="tag new"><span>nuevos</span></div>
            @else
          ...
          <div class="row">
            <div class="col-md-7 col-sm-7">
              <div class="wide-banner cnt-strip">
                <div class="image"> <img class="img-responsive" src="{{ asset('frontend/assets/images/banners/hban1.jpg') }}" alt=""> </div>
              </div>
              <!-- /.wide-banner --> 
            </div>
            <!-- /.col -->
            <div class="col-md-5 col-sm-5">
              <div class="wide-banner cnt-strip">
                <div class="image"> <img class="img-responsive" src="{{ asset('frontend/assets/images/banners/hban2.jpg') }}" alt=""> </div>
              </div>
              <!-- /.wide-banner --> 
            </div>
            <!-- /.col --> 
 ...
 <div class="product-price"> <span class="price"> Q{{ $product->discount_price }} </span> <span class="price-before-discount">Q {{ $product->selling_price }}</span> </div>
        ...
        <div class="wide-banners wow fadeInUp outer-bottom-xs">
          <div class="row">
            <div class="col-md-12">
              <div class="wide-banner cnt-strip">
                <div class="image"> <img class="img-responsive" src="{{ asset('frontend/assets/images/banners/hban3.jpg') }}" alt=""> </div>
...
@if(session()->get('language') == 'hindi') {{ $product->product_name_hin }} @else {{ $product->product_name_en }} @endif
 ...
 <div class="product-price"> <span class="price"> Q{{ $product->discount_price }} </span> <span class="price-before-discount">Q {{ $product->selling_price }}</span> </div>
        ...
        <section class="section latest-blog outer-bottom-vs wow fadeInUp">
          <h3 class="section-title">Lo mejor de nuestro Blog</h3>
              ...
              <div class="item">
                <div class="blog-post">
                  ...
                  <div class="blog-post-info text-left">
                    ...
                    <a href="{{ route('post.details',$blog->id) }}" class="lnk btn btn-primary">Leer más</a> </div>
                  <!-- /.blog-post-info --> 
